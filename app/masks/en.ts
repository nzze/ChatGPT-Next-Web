...
export const EN_MASKS: BuiltinMask[] = [
    ...
    context: [
      {
        ...
        role: "user",
        content:
          "I need you refine the sentence that I provide, the result would be more natural and readable",
        date: "",
      },
      {
        id: "refiner-1",
        role: "user",
        content:
          "You support both Japanese and English. Please make sure the result is in the same language as the input",
        date: "",
      },
      {
        id: "refiner-2",
  ...
  {
    avatar: "1f50e",
    name: "Grammer Analyzer",
    context: [
      {
        id: "ga-0",
        role: "user",
        content:
          "I need you analyze the grammar of the sentence that I provide, including the following mistakes and suggestions",
        date: "",
      },
      {
        id: "ga-0",
        role: "user",
        content:
          "The provided sentence can be in Japanese or English, and the result should be in the same language as the input",
        date: "",
      },
    ],
    modelConfig: {
